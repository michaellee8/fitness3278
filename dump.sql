...
CREATE TABLE `Class` (
  ...
  KEY `Class_Branch_branch_ID_fk` (`branch_ID`),
  KEY `Class_Instructor_instructor_ID_fk` (`instructor_ID`),
  CONSTRAINT `Class_Branch_branch_ID_fk` FOREIGN KEY (`branch_ID`) REFERENCES `Branch` (`branch_ID`),
  CONSTRAINT `Class_Instructor_instructor_ID_fk` FOREIGN KEY (`instructor_ID`) REFERENCES `Instructor` (`instructor_ID`)
...
CREATE TABLE `Enrollment` (
  ...
  KEY `Enrollment_Class_class_ID_fk` (`class_ID`),
  CONSTRAINT `Enrollment_Class_class_ID_fk` FOREIGN KEY (`class_ID`) REFERENCES `Class` (`class_ID`),
  CONSTRAINT `Enrollment_Member_member_ID_fk` FOREIGN KEY (`member_ID`) REFERENCES `Member` (`member_ID`)
...
INSERT INTO `Enrollment` VALUES (4,1),(5,1),(6,2),(8,2),(11,2),(6,3),(11,3),(4,4),(7,4),(10,4),(7,5),(10,5),(11,5),(10,6),(40,6),(5,7),(6,7),(8,7),(9,7),(10,7),(6,8),(10,8),(17,8),(21,8),(26,8),(30,8),(35,8),(41,8),(42,8),(43,8),(9,9),(15,9),(20,9),(23,9),(26,9),(29,9),(32,9),(33,9),(50,10),(44,11),(45,11),(46,11),(1,12),(9,12),(12,12),(35,12),(2,13),(7,13),(13,13),(17,13),(25,13),(26,13),(6,14),(16,14),(18,14),(28,14),(31,14),(3,15),(10,15),(11,15),(23,15),(32,15),(55,17),(56,17),(57,17),(54,18),(49,19),(58,20),(51,21),(52,21),(53,21),(47,22),(48,22),(41,23),(42,23),(43,23),(39,25),(40,25),(37,26),(38,26);
...
CREATE TABLE `Member` (
  ...
  KEY `Member_Member_member_ID_fk` (`referrer_ID`),
  CONSTRAINT `Member_Member_member_ID_fk` FOREIGN KEY (`referrer_ID`) REFERENCES `Member` (`member_ID`)
...
-- Dump completed on 2022-03-31 21:08:36
