...
-- Records of Branch
-- ----------------------------
INSERT INTO `Branch` (`branch_ID`, `name`, `address_street`, `address_district`) VALUES
...
(1, 'Fitness Heroes', 'Pok Fu Lam Road', 'Hong Kong Island (West from North Point)');
...
INSERT INTO `Class` (`class_ID`, `name`, `description`, `date`, `capacity`, `branch_ID`, `instructor_ID`) VALUES
(10, 'Intense gym class (WLI)', 'Strength Center offers intense, weight-based group workouts that will leave you panting for breath.', '2022-01-03', '7', 4, 9),
...
(3, 'Introduce to Yoga (FH)', 'This is a very short course to introduce the curriculum design of our yoga class', '2022-02-01', '5', 1, 9),
...
(11, 'Intense gym class (JWS)', 'This boxing studio is the first of its kind in Hong Kong, with glowing lights inside a dark room, booming beats and dedicated instructors-fifty minutes of class will fly by in the blink of an eye.', '2022-01-02', '10', 5, 7),
...
(24, 'Intense gym class (JWS)', 'Strength Center offers intense, weight-based group workouts that will leave you panting for breath.', '2022-02-26', '3', 5, 9),
(25, 'Intense gym class (TMS)', 'Strength Center offers intense, weight-based group workouts that will leave you panting for breath.', '2022-03-02', '10', 3, 2),
(26, 'Intense gym class (TMS)', 'Strength Center offers intense, weight-based group workouts that will leave you panting for breath.', '2022-03-03', '6', 3, 3);
...
INSERT INTO `Instructor` (`instructor_ID`, `name`, `year_of_experience`) VALUES
(4, 'Jhon Fang', 1),
(3, 'Jerry Leung', 1),
(2, 'Jenifer Chiu', 2),
(1, 'Tom Ng', 3),
...
INSERT INTO `Member` (`member_ID`, `name`, `date_of_birth`, `referrer_ID`) VALUES
(8, 'Alex', '2005-03-03', 3),
